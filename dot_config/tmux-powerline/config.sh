...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/j3/1_5rjv853t3b4t400y898d200000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/sfurukawa/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/sfurukawa/.mailcheckrc"
# }
...
# weather.sh {
	...
	export TMUX_POWERLINE_SEG_WEATHER_GREP="/usr/local/Cellar/grep/3.7/bin/ggrep"
